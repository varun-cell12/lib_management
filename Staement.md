...
There is a need for a simple, menu‑driven application that can maintain book details in a structured digital format.[attached_file:71]
...
The system is intended for small‑scale use where a lightweight solution without a full database is sufficient.[attached_file:71]
...
- Individuals or small personal libraries needing a basic catalog of books.[attached_file:71]
...
5. **List All Books**  
   - Displays all existing book records from the CSV file in a simple text format.[attached_file:71]

These five features form the main functional modules and satisfy the requirement of having at least three major functional modules with a clear input/output structure and logical workflow.[attached_file:71]
